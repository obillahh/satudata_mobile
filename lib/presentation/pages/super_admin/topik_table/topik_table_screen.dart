...
import 'package:satudata_mobile/presentation/pages/super_admin/topik_table/topik_edit_table_screen.dart';

import '../../../../data/repository/api.dart';
import '../../../themes/app_fonts.dart';
import 'create_topik_table_screen.dart';

class TopikTableScreen extends StatefulWidget {
  const TopikTableScreen({Key? key}) : super(key: key);

  @override
  State<TopikTableScreen> createState() => _TopikTableScreenState();
}

class _TopikTableScreenState extends State<TopikTableScreen> {
  @override
  void initState() {
    super.initState();
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const CreateTopicTableScreen(),
                      ),
                    );
                  },
