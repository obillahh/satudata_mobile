...
class AdminEditTopikScreen extends StatefulWidget {
  final ResponseTopic topic;

  const AdminEditTopikScreen({
    Key? key,
    required this.topic,
  }) : super(key: key);

  @override
  State<AdminEditTopikScreen> createState() => _AdminEditTopikScreenState();
}

class _AdminEditTopikScreenState extends State<AdminEditTopikScreen> {
